/* Auto-generated by genmsg_cpp for file /home/jianxin/my_ros_workspace/sandbox/vicon_bridge/msg/TfDistortInfo.msg */
...
private:
  static const char* __s_getDataType_() { return "vicon_bridge/TfDistortInfo"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "a7025291415a53264a70b836a949be8d"; }
public:
...
private:
  static const char* __s_getMessageDefinition_() { return "float64 tf_pub_rate\n\
string tf_ref_frame\n\
string tf_frame_in\n\
string tf_frame_out\n\
int32 delay\n\
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, tf_pub_rate);
    ros::serialization::serialize(stream, tf_ref_frame);
    ros::serialization::serialize(stream, tf_frame_in);
    ros::serialization::serialize(stream, tf_frame_out);
    ros::serialization::serialize(stream, delay);
    ros::serialization::serialize(stream, position_scale);
    ros::serialization::serialize(stream, noise_type);
    ros::serialization::serialize(stream, sigma_roll_pitch);
    ros::serialization::serialize(stream, sigma_yaw);
    ros::serialization::serialize(stream, sigma_xy);
    ros::serialization::serialize(stream, sigma_z);
    ros::serialization::serialize(stream, random_walk_k_xy);
    ros::serialization::serialize(stream, random_walk_k_z);
    ros::serialization::serialize(stream, random_walk_sigma_xy);
    ros::serialization::serialize(stream, random_walk_sigma_z);
    ros::serialization::serialize(stream, random_walk_tau_xy);
    ros::serialization::serialize(stream, random_walk_tau_z);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, tf_pub_rate);
    ros::serialization::deserialize(stream, tf_ref_frame);
    ros::serialization::deserialize(stream, tf_frame_in);
    ros::serialization::deserialize(stream, tf_frame_out);
    ros::serialization::deserialize(stream, delay);
    ros::serialization::deserialize(stream, position_scale);
    ros::serialization::deserialize(stream, noise_type);
    ros::serialization::deserialize(stream, sigma_roll_pitch);
    ros::serialization::deserialize(stream, sigma_yaw);
    ros::serialization::deserialize(stream, sigma_xy);
    ros::serialization::deserialize(stream, sigma_z);
    ros::serialization::deserialize(stream, random_walk_k_xy);
    ros::serialization::deserialize(stream, random_walk_k_z);
    ros::serialization::deserialize(stream, random_walk_sigma_xy);
    ros::serialization::deserialize(stream, random_walk_sigma_z);
    ros::serialization::deserialize(stream, random_walk_tau_xy);
    ros::serialization::deserialize(stream, random_walk_tau_z);
    return stream.getData();
  }
  ...
  {
    uint32_t size = 0;
    size += ros::serialization::serializationLength(tf_pub_rate);
    size += ros::serialization::serializationLength(tf_ref_frame);
    size += ros::serialization::serializationLength(tf_frame_in);
    size += ros::serialization::serializationLength(tf_frame_out);
    size += ros::serialization::serializationLength(delay);
    size += ros::serialization::serializationLength(position_scale);
    size += ros::serialization::serializationLength(noise_type);
    size += ros::serialization::serializationLength(sigma_roll_pitch);
    size += ros::serialization::serializationLength(sigma_yaw);
    size += ros::serialization::serializationLength(sigma_xy);
    size += ros::serialization::serializationLength(sigma_z);
    size += ros::serialization::serializationLength(random_walk_k_xy);
    size += ros::serialization::serializationLength(random_walk_k_z);
    size += ros::serialization::serializationLength(random_walk_sigma_xy);
    size += ros::serialization::serializationLength(random_walk_sigma_z);
    size += ros::serialization::serializationLength(random_walk_tau_xy);
    size += ros::serialization::serializationLength(random_walk_tau_z);
    return size;
  }
