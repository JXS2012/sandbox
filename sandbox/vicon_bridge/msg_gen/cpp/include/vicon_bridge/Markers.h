/* Auto-generated by genmsg_cpp for file /home/jianxin/my_ros_workspace/sandbox/vicon_bridge/msg/Markers.msg */
...
struct Markers_ {
  ...
  ROS_DEPRECATED void get_markers_vec(std::vector< ::vicon_bridge::Marker_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::vicon_bridge::Marker_<ContainerAllocator> >::other > & vec) const { vec = this->markers; }
  ROS_DEPRECATED void set_markers_vec(const std::vector< ::vicon_bridge::Marker_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::vicon_bridge::Marker_<ContainerAllocator> >::other > & vec) { this->markers = vec; }
private:
  static const char* __s_getDataType_() { return "vicon_bridge/Markers"; }
public:
