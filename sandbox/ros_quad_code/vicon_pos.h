...
class vicon_pos{
	...
	std::string* segment,*pos_name,*gripper;
...
public:
	 ...
	 * */
	vicon_pos(std::string segmentname,std::string posname = "", std::string grippername = "");
	...
	//puts the global coordinates of gripper of given subject in the given floats
	void get_gripper_coord(unsigned int,float&,float&,float&);
	void get_gripper_coord(std::string,float&,float&,float&);
